...
if ( ! class_exists( 'ACF' ) ) :
	...
	class ACF {
		...
		function init() {
			 ...
			 * 新增字段
			 */
			acf_include( 'includes/fields/class-acf-field-smart-button.php' );
			acf_include( 'includes/fields/class-acf-field-image-select.php' );
			acf_include( 'includes/fields/class-acf-field-bookmarks.php' );
			/**
