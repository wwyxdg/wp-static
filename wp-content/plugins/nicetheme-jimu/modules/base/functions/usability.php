...
$usability = $nc_option['usability'] ?? array();

if ($usability['friendly_images'] ?? false) {
...
if ($usability['no_category_base'] ?? false) {
...
if ($usability['auto_rename_media_files'] ?? false) {
...
if ($usability['disable_admin_bar'] ?? false) {
...
global $wp_version;
if ($usability['nc_lazyload'] == 1 && !is_admin() && version_compare( $wp_version, '4.5', '<' ) ) {
...
if ($nc_option['wechat_qq_share_custom'] ?? false) {
